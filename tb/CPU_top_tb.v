...
module CPU_top_tb;
    ...
    initial begin
        ...
        //=====================================================
        // Basic instruction results
        //=====================================================

        $display("");
        $display("----- Basic ALU / Memory Tests -----");

        $display("x1  = %h", uut.u_datapath.u_register_set.registers[1]);
        $display("x2  = %h", uut.u_datapath.u_register_set.registers[2]);
        $display("x3  = %h", uut.u_datapath.u_register_set.registers[3]);
        $display("x4  = %h", uut.u_datapath.u_register_set.registers[4]);
        $display("x5  = %h", uut.u_datapath.u_register_set.registers[5]);
        $display("x6  = %h", uut.u_datapath.u_register_set.registers[6]);
        $display("x7  = %h", uut.u_datapath.u_register_set.registers[7]);
        $display("x8  = %h", uut.u_datapath.u_register_set.registers[8]);
        ...
        // x9 should remain zero because BEQ skipped:
        // ADDI x9, x0, 1
        ...
        // JAL x13,+8 should write PC+4 = 0x40
